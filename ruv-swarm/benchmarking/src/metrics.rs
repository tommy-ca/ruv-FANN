...
impl MetricsCollector {
    ...
    pub fn finalize(self) -> PerformanceMetrics {
        ...
        PerformanceMetrics {
            ...
            time_to_first_output: self.first_output_time
            ...
            network_bandwidth: self.calculate_resource_usage(&self.resource_samples, |s| s.network_kb_per_sec),
            disk_io: self.calculate_resource_usage(&self.resource_samples, |s| s.disk_io_kb_per_sec),
...
impl MetricType {
    ...
    pub fn unit(&self) -> &'static str {
        match self {
            ...
            MetricType::CpuUsagePeak => "percent",
            
            MetricType::MemoryUsageAverage |
            MetricType::MemoryUsagePeak => "MB",
            
            MetricType::NetworkBandwidth |
            MetricType::DiskIO => "KB/s",
        }
    }
}

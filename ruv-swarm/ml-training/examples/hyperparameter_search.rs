                ...
                for agent_id in 0..3 {
                    ...
                    events.push(StreamEvent {
                        ...
                        performance_metrics: PerformanceMetrics {
                            latency_ms: 40.0 * agent_factor + 20.0 * hour_factor + 10.0 * day_factor,
...
async fn optimize_lstm() -> Result<(), Box<dyn std::error::Error>> {
    ...
    parameters.insert(
        ...
        ParameterRange::Discrete { values: vec![64.0, 128.0, 256.0, 512.0] },
    );
    parameters.insert(
        "num_layers".to_string(),
        ParameterRange::Discrete { values: vec![1.0, 2.0, 3.0, 4.0] },
    );
    parameters.insert(
        "dropout".to_string(),
    ...
    parameters.insert(
        ...
        ParameterRange::Continuous { min: 0.0001, max: 0.01 },
    );
...
async fn optimize_tcn() -> Result<(), Box<dyn std::error::Error>> {
    ...
    parameters.insert(
        ...
        ParameterRange::Discrete { values: vec![2.0, 3.0, 4.0, 5.0] },
    );
    parameters.insert(
        "dropout".to_string(),

...
mod tests {
    ...
    fn test_adamw_training() {
        ...
        let mut trainer = AdamW::new(0.01)
    ...
    fn test_batch_backprop_training() {
        ...
        let mut trainer = BatchBackprop::new(0.1)
            .with_momentum(0.9);
    ...
    fn test_all_algorithms_improve_error() {
        ...
        let algorithms: Vec<(&str, Box<dyn TrainingAlgorithm<f32>>)> = vec![
            ...
            ("IncrementalBackprop", Box::new(IncrementalBackprop::new(0.1))),
